      ...
      <div className="container-wide section-padding relative z-10 pt-32 lg:pt-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            >
              Recupera tu bienestar con tratamientos de
              <span className="text-secondary font-semibold"> suelo pélvico</span>,
              <span className="text-secondary font-semibold"> embarazo y posparto</span>,
              <span className="text-secondary font-semibold"> pilates terapéutico</span> y más.
            </motion.p>
